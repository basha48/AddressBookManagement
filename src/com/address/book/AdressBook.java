...
import java.util.Scanner;
	...
	List<Contacts> people = new ArrayList();
	 Dictionary addressSystem = new Hashtable();
	...
	public void addContacts() {
	 ...
	 public void addAddressBook() {
		...
		addressSystem.put(bookName, ab);
		
	 }
	 
	 public void listOfAdress() {
		 for (Enumeration k = addressSystem.keys(); k.hasMoreElements();)
	        {
	            System.out.println("Address Names in Address System is : " + k.nextElement());
	        }
